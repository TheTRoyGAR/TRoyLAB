...
import { istanbulAttractions, istanbulEvents, istanbulPackageSlugs } from '@/lib/data/istanbul-guide'
import { travelPackages } from '@/lib/data/packages'

export const revalidate = 3600

export const metadata: Metadata = {
  title: 'Istanbul Today — Weather, Season & What’s On | Istanbul Travel Guide',
  description:
    'Istanbul today: live weather, UV, sunrise & sunset for Istanbul, Turkey, plus what’s on this season, the best time to visit, top things to do, and real Türkiye tour packages.',
  keywords: [
    'Istanbul today',
    'Istanbul travel guide',
    'what is in Istanbul today',
    'what’s on in Istanbul today',
  ...
  openGraph: {
    title: 'Istanbul Today — Live Weather, Season & What’s On',
    description:
      'Live conditions for Istanbul, Turkey right now, plus a full travel guide: best time to visit, top attractions, annual events and real Türkiye tour packages.',
    type: 'website',
    url: 'https://troytravelagency.com/travel-guide/istanbul',
  },
}
...
export default async function IstanbulTravelGuidePage() {
  const today = await getIstanbulToday()

  const istanbulPackages = istanbulPackageSlugs
  ...
  const jsonLd = {
    ...
    description:
      'Istanbul travel guide covering live daily conditions, the best time to visit, top attractions, annual events, and Türkiye tour packages.',
    url: 'https://troytravelagency.com/travel-guide/istanbul',
    containedInPlace: {
      '@type': 'Country',
      name: 'Turkey',
    ...
    <MainLayout>
      ...
      <div style={{ background: '#0A1628' }} className="text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12">
          ...
          <p className="text-white/70 leading-relaxed max-w-2xl">
            The only city on earth spanning two continents — Byzantine domes, Ottoman palaces,
            and the gateway to Troy, Cappadocia and the Aegean coast. Here&apos;s what Istanbul
            is like right now, and everything you need to plan a trip.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex items-baseline justify-between flex-wrap gap-2 mb-1">
            ...
            <span className="text-xs text-gray-400">
              {today.localDayOfWeek}, {today.localDateLabel} · Istanbul local time
            </span>
          </div>
      ...
      <div className="bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <p className="text-sm text-gray-500 mb-6">
            Istanbul&apos;s recurring annual festivals and events. Exact dates shift year to year —
            confirm current listings before you travel.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {istanbulEvents.map((event) => (
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 md:grid-cols-2 gap-10">
          <div>
            ...
            <p className="text-sm text-gray-600 leading-relaxed mb-3">
              <strong>Spring (April–May) and autumn (September–October)</strong> bring mild,
              comfortable weather and thinner crowds — generally the best balance for sightseeing.
            </p>
            <p className="text-sm text-gray-600 leading-relaxed">
              <strong>Summer (June–August)</strong> is hot and the busiest season, while
              <strong> winter (December–February)</strong> is cool and rainy but the quietest
              and least expensive time to visit.
            </p>
          </div>
          <div>
            ...
            <p className="text-sm text-gray-600 leading-relaxed mb-3">
              Istanbul Airport (IST) is one of the world’s busiest international hubs, with
              extensive direct connections across Europe, Asia and beyond.
            </p>
      ...
      <div className="bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <p className="text-sm text-gray-600 leading-relaxed mb-4 max-w-2xl">
            From the historic Sultanahmet old town to the Bosphorus-front Beşiktaş and
            Karaköy districts, search TRoyGO™&apos;s hotel inventory for current Istanbul stays.
          </p>
          <Link
            href="/hotels?destination=Istanbul"
