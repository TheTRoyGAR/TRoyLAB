...
const SECTIONS = [
  {
    ...
    links: [
      ...
      { label: 'Tokyo Travel Guide', href: '/travel-guide/tokyo' },
      { label: 'Bangkok Travel Guide', href: '/travel-guide/bangkok' },
      { label: 'Sydney Travel Guide', href: '/travel-guide/sydney' },
